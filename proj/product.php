            ...
            <div class="row">
               <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="img/product-1.jpg" alt=""></i>
               ...
               <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="img/product-2.jpg" alt=""></i>
                     <h3>Norton Internet Security</h3>
                     <span>$25.00</span>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="img/product-3.jpg" alt=""></i>
                     <h3>Norton Internet Security</h3>
                     <span>$25.00</span>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="img/product-4.jpg" alt=""></i>
                     <h3>Norton Internet Security</h3>
                     <span>$25.00</span>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="img/product-5.jpg" alt=""></i>
                     <h3>Norton Internet Security</h3>
                     <span>$25.00</span>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="img/product-6.jpg" alt=""></i>
                     <h3>Norton Internet Security</h3>
                     <span>$25.00</span>
                  </div>
               </div>
